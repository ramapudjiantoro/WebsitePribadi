...
const socialLinks = [
  ...
  { icon: SiLinkedin, href: "https://www.linkedin.com/in/anugrahpudjiantoro/", label: "LinkedIn", username: "Rama Pudjiantoro" },
  { icon: SiGithub, href: "https://github.com/ramapudjiantoro", label: "GitHub", username: "@ramapudjiantoro" },
